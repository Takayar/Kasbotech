...
namespace Kasbotech_AvgCandle.MessagingBus.RecivedMessages
{
...

    {
        ...
        private readonly ICandleAvgService _candleAvgService;

        public RecivedCandleMessage(IOptions<RabbitMqConfiguration> rabbitMqOptions,
            ICandleAvgService candleAvgService)
        {
            _candleAvgService = candleAvgService;
            _hostname = rabbitMqOptions.Value.HostName;
            _username = rabbitMqOptions.Value.UserName;
            _password = rabbitMqOptions.Value.Password;
            _queueName = rabbitMqOptions.Value.QueueName_Candle;
            _exchangeName = rabbitMqOptions.Value.ExchangeName_Avg;
